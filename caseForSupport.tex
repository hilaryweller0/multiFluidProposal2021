...
\begin{figure}
\begin{tabular}{cc}
	\includegraphics[width=0.25\linewidth]{fromWill/04_Proposal_Exeter_Progress/updraftFraction_32.png}&
	\includegraphics[width=0.73\linewidth]{fromWill/04_Proposal_Exeter_Progress/timeseries_cloud_height2.png}\\
	$\sigma_1$ & Time (hours)
\end{tabular}
...
\workPackage{Flexible Modelling Framework (Weller, Shipley) \label{WP:model0}}
